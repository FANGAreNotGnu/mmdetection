...
num_classes = 1
data_root = '/media/data/odinw/odinw13/Raccoon/Raccoon.v2-raw.coco/'
classes = ('raccoon',)
palette = [(106, 0, 228),]
train_ann_file = 'train/annotations_without_background.json'
train_img_folder = 'train/'
test_ann_file = 'test/annotations_without_background.json'
