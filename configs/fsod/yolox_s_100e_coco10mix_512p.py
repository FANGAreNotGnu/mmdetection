...
train_data_root = "/media/data/dad/cnet/experiments/coco10s1_512p/mix_n333-333_dfsNone_o0_m0_s1_HED_p512_promptcat_seed1_noprompt_imprior_avgacsl30"
...
# CUDA_VISIBLE_DEVICES=7 python3 tools/train.py configs/fsod/yolox_s_100e_coco10mix_512p.py --auto-scale-lr --cfg-options randomness.seed=1
# bash tools/dist_train.sh configs/fsod/yolox_s_100e_coco10mix_512p.py 4 --auto-scale-lr --cfg-options randomness.seed=1
