...
train_data_root = "/media/data/dad/cnet/experiments/coco10novelsquare320_1e-6_200e/mix_n2000_o1_s1_p320_pfa_csl_p20_pfb_csl20"
...
optim_wrapper = dict(
    type='OptimWrapper',
    optimizer=dict(
        type='SGD', lr=base_lr, momentum=0.8, weight_decay=5e-4,
        nesterov=True),
...
# CUDA_VISIBLE_DEVICES=2 python3 tools/train.py configs/fsod/yolox_s_50e_coco_10shot_mix_pfab.py --auto-scale-lr
